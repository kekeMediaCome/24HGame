...
public class VNTextView extends AppCompatTextView {
    ...
    public VNTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    private void initAttributeSet(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.VNTextView);
        //corner
        mCornerRadius = a.getDimensionPixelSize(R.styleable.VNTextView_corner_radius, -1);
        mCornerRadiusTopLeft = a.getDimensionPixelSize(R.styleable.VNTextView_corner_radius_top_left, 0);
        mCornerRadiusTopRight = a.getDimensionPixelSize(R.styleable.VNTextView_corner_radius_top_right, 0);
        mCornerRadiusBottomLeft = a.getDimensionPixelSize(R.styleable.VNTextView_corner_radius_bottom_left, 0);
        mCornerRadiusBottomRight = a.getDimensionPixelSize(R.styleable.VNTextView_corner_radius_bottom_right, 0);
        //border
        mBorderDashWidth = a.getDimensionPixelSize(R.styleable.VNTextView_border_dash_width, 0);
        mBorderDashGap = a.getDimensionPixelSize(R.styleable.VNTextView_border_dash_gap, 0);
        mBorderWidthNormal = a.getDimensionPixelSize(R.styleable.VNTextView_border_width_normal, 0);
        mBorderWidthPressed = a.getDimensionPixelSize(R.styleable.VNTextView_border_width_pressed, 0);
        mBorderWidthUnable = a.getDimensionPixelSize(R.styleable.VNTextView_border_width_unable, 0);
        mBorderColorNormal = a.getColor(R.styleable.VNTextView_border_color_normal, Color.TRANSPARENT);
        mBorderColorPressed = a.getColor(R.styleable.VNTextView_border_color_pressed, Color.TRANSPARENT);
        mBorderColorUnable = a.getColor(R.styleable.VNTextView_border_color_unable, Color.TRANSPARENT);
        //icon
        //Vector兼容处理
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mIconNormal = a.getDrawable(R.styleable.VNTextView_icon_src_normal);
            mIconPressed = a.getDrawable(R.styleable.VNTextView_icon_src_pressed);
            mIconUnable = a.getDrawable(R.styleable.VNTextView_icon_src_unable);
        } else {
            int normalId = a.getResourceId(R.styleable.VNTextView_icon_src_normal, -1);
            int pressedId = a.getResourceId(R.styleable.VNTextView_icon_src_pressed, -1);
            int unableId = a.getResourceId(R.styleable.VNTextView_icon_src_unable, -1);
        ...
        mIconWidth = a.getDimensionPixelSize(R.styleable.VNTextView_icon_width, 0);
        mIconHeight = a.getDimensionPixelSize(R.styleable.VNTextView_icon_height, 0);
        mIconDirection = a.getInt(R.styleable.VNTextView_icon_direction, ICON_DIR_LEFT);
        //text
        mTextColorNormal = a.getColor(R.styleable.VNTextView_text_color_normal, getCurrentTextColor());
        mTextColorPressed = a.getColor(R.styleable.VNTextView_text_color_pressed, getCurrentTextColor());
        mTextColorUnable = a.getColor(R.styleable.VNTextView_text_color_unable, getCurrentTextColor());
        //background
        mBackgroundColorNormal = a.getColor(R.styleable.VNTextView_background_normal, 0);
        mBackgroundColorPressed = a.getColor(R.styleable.VNTextView_background_pressed, 0);
        mBackgroundColorUnable = a.getColor(R.styleable.VNTextView_background_unable, 0);
        //typeface
        mTypefacePath = a.getString(R.styleable.VNTextView_text_typeface);
    ...
    public VNTextView setStateBackgroundColor(int normal, int pressed, int unable) {
    ...
    public VNTextView setBackgroundColorNormal(int colorNormal) {
    ...
    public VNTextView setBackgroundColorPressed(int colorPressed) {
    ...
    public VNTextView setBackgroundColorUnable(int colorUnable) {
    ...
    public VNTextView setTypeface(String typefacePath) {
    ...
    public VNTextView setIconNormal(Drawable icon) {
    ...
    public VNTextView setIconPressed(Drawable icon) {
    ...
    public VNTextView setIconUnable(Drawable icon) {
    ...
    public VNTextView setIconSize(int iconWidth, int iconHeight) {
    ...
    public VNTextView setIconWidth(int iconWidth) {
        this.mIconWidth = iconWidth;
        setIcon();
        return this;
    }
    ...
    public VNTextView setIconHeight(int iconHeight) {
        this.mIconHeight = iconHeight;
        setIcon();
        return this;
    }
    ...
    public VNTextView setIconDirection(int iconDirection) {
    ...
    public VNTextView setTextColorNormal(int textColor) {
    ...
    public VNTextView setPressedTextColor(int textColor) {
    ...
    public VNTextView setTextColorUnable(int textColor) {
    ...
    public VNTextView setBorderWidthNormal(int width) {
    ...
    public VNTextView setBorderColorNormal(int color) {
    ...
    public VNTextView setBorderWidthPressed(int width) {
    ...
    public VNTextView setBorderColorPressed(int color) {
    ...
    public VNTextView setBorderWidthUnable(int width) {
    ...
    public VNTextView setBorderColorUnable(int color) {
    ...
    public VNTextView setCornerRadiusTopLeft(float topLeft) {
    ...
    public VNTextView setCornerRadiusTopRight(float topRight) {
        this.mCornerRadius = -1;
    ...
    public VNTextView setCornerRadiusBottomRight(float bottomRight) {
        this.mCornerRadius = -1;
    ...
    public VNTextView setCornerRadiusBottomLeft(float bottomLeft) {
        this.mCornerRadius = -1;
