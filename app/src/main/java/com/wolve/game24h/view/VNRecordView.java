package com.wolve.game24h.view;
...
public class VNRecordView extends View implements View.OnLongClickListener, View.OnClickListener {
    ...
    public VNRecordView(Context context) {
        this(context, null);
    }

    public VNRecordView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VNRecordView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public VNRecordView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        progressWidth = typedArray.getDimensionPixelOffset(R.styleable.RecordView_progress_width, VNPixUtils.dp2px(3));
